...
<fieldset style="width:543px;" >
	<legend><i class="facebox-header"><i class="edit large icon"></i>&nbsp;Mettre a jour <b>( <?php echo strtoupper($selExmne['exmne_fullname']); ?> )</b></i></legend>
...
<form method="post" id="updateExamineeFrm">
     ...
     <div class="form-group">
        <legend>Niveau de l'année</legend>
